...
def display(result):
    ...
    dropDown.set('Results')
    option=tk.OptionMenu(root,dropDown,*result)
    option.pack()
    root.mainloop()
...
def queryFile(query):
	print "writing query into a file query.txt "
	q=open(queries_file,"w")
	q.write(query)
	q.close()
class SampleApp(tk.Tk):
    def __init__(self):
        ...
        self.label = tk.Label(self,text="Welcome to BINRE")
